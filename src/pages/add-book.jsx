            ...
            <div class="mt-5 md:col-span-2 md:mt-0">
                ...
                <div class="shadow sm:overflow-hidden sm:rounded-md">
                    ...
                    <div class="space-y-6 bg-white px-4 py-5 sm:p-6">
                        <div class="grid grid-cols-3 gap-6">
                            <div class="col-span-6 w-full">
                                ...
                                <div class="mt-1 flex rounded-md shadow-sm">
                                    <input type="text" name="name" id="name" class="block w-full flex-1 rounded-none rounded-r-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm p-2" placeholder="The great gatsby" onChange={bookNameChangeHandler} value={bookName} />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-3 gap-6">
                            <div class="col-span-6 w-full">
                                ...
                                <div class="mt-1 flex rounded-md shadow-sm">
                                    <input type="number" name="noOfPages" id="noOfPages" class="block w-full flex-1 rounded-none rounded-r-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm p-2" placeholder="200" value={noOfPages} onChange={noOfPagesChangeHandler} />
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="space-y-1 text-center">
                                    ...
                                    <div class="flex text-sm text-gray-600">
                                        <label for="file-upload" class="relative cursor-pointer rounded-md bg-white font-medium text-indigo-600 focus-within:outline-none focus-within:ring-2 focus-within:ring-indigo-500 focus-within:ring-offset-2 hover:text-indigo-500">
                                            ...
                                            <input id="file-upload" name="file-upload" type="file" class="sr-only" onChange={profileChangeHandler} value={profileImage} />
                                        </label>
                    ...
                    <div class="bg-gray-50 px-4 py-3 text-right sm:px-6">
                        <button type="button" class="inline-flex justify-center rounded-md border border-transparent bg-indigo-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2" onClick={addBookSubmitHandler}>Add</button>
                    </div>
                </div>
